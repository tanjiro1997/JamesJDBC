...
public class MemberDAO {
	...
	private final String USERNAME = "JAMESJDBC";
	private final String PASSWORD = "JAMESJDBC";
...
//			conn.close();
	...
	public int updateMember(Member modifyInfo) {
		...
		try {
			...
			if(result > 0 ) {
				...
				conn.rollback(); // 롤백, 최근 커밋 시점으로 이동(원복)
			}
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		// 호출한 곳에서 써야되니까 return result, MemberController:?
		return result;
	}
	...
	public int deleteMember(String memberId) {
		...
		// try 안에서 쓴 변수는 return 안되니까 try 밖에서 int result = 0;
		// 호출한 곳에서 써야되니까 return result, MemberController:43
		return result;
	}
	...
	public Member selectOne(String memberId) {
		...
		// try 안에서 쓴 변수는 return 안되니까 try 밖에서 Member member = null;
		// 호출한 곳에서 써야되니까 return member, MemberController:33
		return member;
	}
	...
	public List<Member> selectList() {
		...
		// 호출한 곳에서 써야되니까 return mList, MemberController:24
		return mList;
	}

	// return이 있으니까 void 대신 Member
